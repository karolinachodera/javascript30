	...
	var age = inventors.sort(function(inventorA, inventorB) {
	...
	var sortTotal = inventors.sort(function(inventorA, inventorB) {
		return (inventorA.passed - inventorA.year) - (inventorB.passed - inventorB.year);
	});
	console.table(sortTotal);
	...
	var last = people.sort(function(a, b) {
